...
if [ -z "$query_vcf" ]; then # when there's NO query file
	touch /home/dnanexus/out/summary_csv/noQueryVcfFound.summary_csv
	touch /home/dnanexus/out/summary_html/noQueryVcfFound.summary_html
	touch /home/dnanexus/out/detailed_results/noQueryVcfFound.detailed_results
	...
	dx cat project-Fkb6Gkj433GVVvj73J7x8KbV:file-Fjp4k3Q4yBGZYpQg3bgpPG95 | tar xf - 
	...
	echo "tabix,v1.2.1-2ubuntu1" >> "$prefix".version-log.csv
